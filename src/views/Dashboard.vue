        ...
        <div class="signup--intro--content">
          <div class="signup--intro--content--profile">
            <div class="signup--intro--content--profile--image">
              <img src="@/assets/pfp.svg" alt="" v-on:change="image" />
          ...
          <div class="signup--intro--content--tab">
            ...
            <div class="signup--intro--content--tab--summary">
              <div v-if="expenses.length === 0">Nothing To Show Yet</div>
              <div v-else>
                ...
                <div
                  ...
                  :key="expense.date"
                  class="signup--intro--content--tab--summary--content"
                >
                  <svg
                    width="13"
                    height="13"
                  ...
                  >
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M6.06372 12.1274C9.41262 12.1274 12.1274 9.41262 12.1274 6.06372C12.1274 2.71482 9.41262 0 6.06372 0C2.71482 0 0 2.71482 0 6.06372C0 9.41262 2.71482 12.1274 6.06372 12.1274Z"
                      fill="#4DE897"
                    />
                  </svg>
                  <p>{{ expense.date }}</p>
      ...
      <div class="signup--form">
        <div class="signup--form--welcome">
          <div class="signup--form--welcome--text">
            <h2><span>Welcome back,</span> {{ firstname }}</h2>
          ...
          <div class="signup--form--container">
            ...
            <div class="actual--expense">
              ...
              <div class="actual--expense--input">
                ...
                <input
                  type="text"
                  v-model="expenseData.total"
                  placeholder="40,000"
                  readonly
                />
              </div>
            </div>
            <button class="button--expense">SAVE TODAY’S EXPENSES</button>
          </div>
        </form>
      </div>
    </div>
...
export default {
  ...
  async created() {
    ...
    this.percent = (5000 / this.expense) * 100;
  },
  methods: {
    handlesubmit() {
