            ...
            <div class="signup--form--welcome">
              ...
              <form @submit.prevent = "handlesubmit">
                  <div class="signup--form--container">
                      ...
                      <div class="signup--form--input">
                          <label>Date</label>
                          <input id="datepicker" v-model="date" type="date" name="" required>
                      </div>
                          <label for="">Today’s Expenses</label>
                       <div class="signup--form--name--box">
                          <div class="signup--form--name">
                              <input type="text" placeholder="Pizza" id="" required>
                          </div>
                          <div class="signup--form--name">
                       ...
                       <div class="signup--form--name--box">
                          <div class="signup--form--name">
                              <input type="text" placeholder="Textbook" id="" required>
                          </div>
                          <div class="signup--form--name">
                      ...
                      <div class="signup--form--name--box">
                          <div class="signup--form--name">
                              <input type="text" placeholder="Tuition Fee" id="" required>
                          </div>
                          <div class="signup--form--name">
