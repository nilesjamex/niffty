              ...
              <form action="">
                  <div class="signup--form--container">
                      ...
                      <div class="signup--form--input">
                          ...
                          <input type="text" value="596,000" readonly placeholder="Enter Email" id="">
                      </div>
                      <div class="signup--form--input">
                          <label>Date</label>
                          <input id="datepicker" type="date" name="" value="04/08/2022" readonly>
                      </div>
                       ...
                       <div class="signup--form--name--box">
                          ...
                          <div class="signup--form--name">
                              <input type="number" name="" placeholder="10,000" id="">
                          </div>
                      </div>
                       <div class="signup--form--name--box">
                          <div class="signup--form--name">
