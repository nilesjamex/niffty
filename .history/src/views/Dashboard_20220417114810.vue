              ...
              <div class="signup--intro--content">
                  ...
                  <div class="signup--intro--content--tab">
                    ...
                    <div class="signup--intro--content--tab--summary">
                      ...
                      <div class="signup--intro--content--tab--summary--content">
            ...
            <div class="signup--form--welcome">
              ...
              <form @submit.prevent = "handlesubmit">
                  <div class="signup--form--container">
                      ...
                      <div class="signup--form--input">
                          <label>Date</label>
                          <input id="datepicker" v-model="date" type="date" name="" >
                      </div>
                          <label for="">Today’s Expenses</label>
                       <div class="signup--form--name--box">
                          <div class="signup--form--name">
                              <input type="text" placeholder="Pizza" id="">
                          </div>
                          <div class="signup--form--name">
                              <input type="number" v-model="expense1" name="" placeholder="10,000" id="">
                          </div>
                      </div>
                       <div class="signup--form--name--box">
                          <div class="signup--form--name">
                              <input type="text" placeholder="Textbook" id="">
                          </div>
                          <div class="signup--form--name">
                              <input type="number" v-model="expense2" name="" placeholder="10,000" id="">
                          </div>
                      </div>
                      <div class="signup--form--name--box">
                          <div class="signup--form--name">
                              <input type="text" placeholder="Tuition Fee" id="">
                          </div>
                          <div class="signup--form--name">
                              <input type="number" v-model="expense3" name="" placeholder="10,000" id="">
                          </div>
                      </div>
                      <div class="actual--expense">
                        ...
                        <div class="actual--expense--input">
                          <p>₦</p><input type="number" v-model="total" placeholder="40,000" readonly>
                        </div>
                      </div>
...
export default {
  methods: {
    handlesubmit() {
      this.percent = Math.trunc(this.total/this.expense*100);
      console.log(this.percent)
    }
  },
  watch: {
    expense1(newExpense1, oldExpense1) {
      this.total = newExpense1 + this.expense2 + this.expense3
    },
    expense2(newExpense2, oldExpense2) {
      this.total = newExpense2 + this.expense1 + this.expense3
    },
    expense3(newExpense3, oldExpense3) {
      this.total = newExpense3 + this.expense2 + this.expense3
    }
  },
  data() {
    return {
