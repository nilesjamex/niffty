                  ...
                  <div class="signup--form--container">
                      <div class="signup--form--name--box">
                          ...
                          <div class="signup--form--name">
                              ...
                              <input type="text" name="" v-model="form.fullName" placeholder="Enter First Name" id="">
                          </div>
                          <div class="signup--form--name">
                      ...
                      <div class="signup--form--input">
                          ...
                          <input type="password" name="" v-model="form.password_confirmation" placeholder="Confirm Password" id="">
                      </div>
...
methods: {
    ...
    axios.post('https://campaign.fundall.io/api/v1/register', {headers: headers}, this.form)
    .then(
        res => {
            console.log(res)
        }
